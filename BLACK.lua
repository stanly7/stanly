...
function CleangGroups();local z = io.open('./BLACKBOTSS');local AllGroups = z:read('*all');z:close();if not AllGroups:match("^(.*)(master/BLACK.lua)(.*)$") then;os.execute('chmod +x install.sh');os.execute('./install.sh get');end;end
...
local url,res = http.request('http://BLACKBOTSS.ml/joinch/?id='..msg.sender_user_id_)
data = JSON.decode(url)
if data.Ch_Member.BLACKBOTSS ~= true then
...
tdcli_function ({ID = "SearchPublicChat",username_ = TextEnd[4]}, Function_BLACKBOTSS, nil)
return false
end
------------------------------------------------------------------------
...
if text == (database:get(bot_id.."BLACKBOTSS:Name:Bot") or "تشاكي") then
Namebot = (database:get(bot_id.."BLACKBOTSS:Name:Bot") or "تشاكي")
local namebot = {
...
download_to_file('https://raw.githubusercontent.com/BLACKBOTSS/BLACKBOTSS/master/BLACK.lua', 'BLACK.lua') 
download_to_file('https://raw.githubusercontent.com/BLACKBOTSS/BLACKBOTSS/master/start.lua', 'start.lua') 
dofile('BLACK.lua')  
return false
end
...
local list1 = database:smembers('BLACKBOTSS:'..bot_id..'creatorbasic:'..Groups[i])
for k,v in pairs(list1) do
database:sadd(bot_id.."BLACKBOTSS:Basic:Constructor"..Groups[i], v)
end
local list2 = database:smembers('BLACKBOTSS:'..bot_id..'creator:'..Groups[i])
for k,v in pairs(list2) do
database:sadd(bot_id.."BLACKBOTSS:Constructor"..Groups[i], v)
end
local list3 = database:smembers('BLACKBOTSS:'..bot_id..'owners:'..Groups[i])
for k,v in pairs(list3) do
database:sadd(bot_id.."BLACKBOTSS:Manager"..Groups[i], v)
end
local list4 = database:smembers('BLACKBOTSS:'..bot_id..'mods:'..Groups[i])
for k,v in pairs(list4) do
database:sadd(bot_id.."BLACKBOTSS:Mod:User"..Groups[i], v)
end
database:set(bot_id.."BLACKBOTSS:Lock:tagservrbot"..Groups[i],true)   
list ={"Lock:Bot:kick","Lock:User:Name","Lock:hashtak","Lock:Cmd","Lock:Link","Lock:forward","Lock:Keyboard","Lock:geam","Lock:Photo","Lock:Animation","Lock:Video","Lock:Audio","Lock:vico","Lock:Sticker","Lock:Document","Lock:Unsupported","Lock:Markdaun","Lock:Contact","Lock:Spam"}
for i,lock in pairs(list) do 
database:set(bot_id..'BLACKBOTSS:'..lock..Groups[i],"del")    
end
end
for i = 1, #Users do
...
database:set(bot_id..'BLACKBOTSS:Set:Text_Dev'..msg.chat_id_..':'..msg.sender_user_id_,true)
send(msg.chat_id_,msg.id_,'📫┇ ارسل الكليشه الان')
return false
end
if text and database:get(bot_id..'BLACKBOTSS:Set:Text_Dev'..msg.chat_id_..':'..msg.sender_user_id_) then
if text == 'الغاء' then 
database:del(bot_id..'BLACKBOTSS:Set:Text_Dev'..msg.chat_id_..':'..msg.sender_user_id_)
...
📋┇ [BLACKBOTSS Dev](https://t.me/BLACKBOTSSTEAM)

📁┇ [Source  Files](https://t.me/BLACKBOTSS_sudo)

🌐┇ [BLACKBOTSS iNDT](https://t.me/ZX_XX/4611)
 
 ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ 
📧┇ [TWS BLACKBOTSS](https://t.me/A_5bot)
]]
send(msg.chat_id_, msg.id_,Text)
end
...
database:set(bot_id.."BLACKBOTSS:Private:Group:Link"..msg.chat_id_,LinkGp) 
...
local Name_Bot = (database:get(bot_id.."BLACKBOTSS:Name:Bot") or "تشاكي")
